  ...
  return (
    !babyBirthDate ? (
      ...
      <div className="space-y-8 mt-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Activity /> Baby Growth Journey</CardTitle>
            <CardDescription>Watch this video to understand your baby's developmental milestones.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="aspect-video w-full rounded-lg overflow-hidden bg-black">
              <video
                ...
                preload="metadata"
              >
                <source src="/videos/baby-growth.mp4" type="video/mp4" />
              ...
              <CardContent>
                <Form {...postBirthForm}>
                  <form onSubmit={postBirthForm.handleSubmit(onPostBirthSubmit)} className="grid sm:grid-cols-2 gap-4">
                    <FormField control={postBirthForm.control} name="weight" render={({ field }) => (
                      <FormItem>
                        <FormLabel>Weight (kg)</FormLabel>
                        <FormControl>
                          <Input type="number" step="0.1" placeholder="e.g. 3.5" {...field} value={field.value ?? ''} />
                        </FormControl>
                      </FormItem>
                    )} />
                    <FormField control={postBirthForm.control} name="height" render={({ field }) => (
                      <FormItem>
                    ...
                    <FormField control={postBirthForm.control} name="headCircumference" render={({ field }) => (
                      <FormItem>
                        <FormLabel>Head Circumference (cm)</FormLabel>
                        <FormControl>
                          <Input type="number" step="0.1" placeholder="e.g. 34" {...field} value={field.value ?? ''} />
                        </FormControl>
                      </FormItem>
                    )} />
                    <FormField
